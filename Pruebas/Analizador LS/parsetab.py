...
_lr_productions = [
  ...
  ('program -> block','program',1,'p_program','analizador_Sintactico.py',23),
  ('block -> constDecl varDecl procDecl statement','block',4,'p_block','analizador_Sintactico.py',28),
  ('constDecl -> CONST constAssignmentList SEMMICOLOM','constDecl',3,'p_constDecl','analizador_Sintactico.py',32),
  ('constDecl -> empty','constDecl',1,'p_constDeclEmpty','analizador_Sintactico.py',36),
  ('constAssignmentList -> ID ASSIGN NUMBER','constAssignmentList',3,'p_constAssignmentList','analizador_Sintactico.py',41),
  ('constAssignmentList -> constAssignmentList COMMA ID ASSIGN NUMBER','constAssignmentList',5,'p_constAssignmentList2','analizador_Sintactico.py',45),
  ('varDecl -> VAR identList SEMMICOLOM','varDecl',3,'p_varDecl1','analizador_Sintactico.py',49),
  ('varDecl -> empty','varDecl',1,'p_varDecl2','analizador_Sintactico.py',53),
  ('identList -> ID','identList',1,'p_identList1','analizador_Sintactico.py',57),
  ('identList -> identList COMMA ID','identList',3,'p_identList2','analizador_Sintactico.py',61),
  ('procDecl -> procDecl PROCEDURE ID SEMMICOLOM block SEMMICOLOM','procDecl',6,'p_procDecl1','analizador_Sintactico.py',65),
  ('procDecl -> empty','procDecl',1,'p_procDeclEmpty','analizador_Sintactico.py',69),
  ('statement -> ID UPDATE expression','statement',3,'p_statement1','analizador_Sintactico.py',73),
  ('statement -> CALL ID','statement',2,'p_statement2','analizador_Sintactico.py',77),
  ('statement -> BEGIN statementList END','statement',3,'p_statement3','analizador_Sintactico.py',81),
  ('statement -> IF condition THEN statement','statement',4,'p_statement4','analizador_Sintactico.py',85),
  ('statement -> WHILE condition DO statement','statement',4,'p_statement5','analizador_Sintactico.py',89),
  ('statement -> empty','statement',1,'p_statementEmpty','analizador_Sintactico.py',93),
  ('statementList -> statement','statementList',1,'p_statementList1','analizador_Sintactico.py',97),
  ('statementList -> statementList SEMMICOLOM statement','statementList',3,'p_statementList2','analizador_Sintactico.py',101),
  ('condition -> ODD expression','condition',2,'p_condition1','analizador_Sintactico.py',105),
  ('condition -> expression relation expression','condition',3,'p_condition2','analizador_Sintactico.py',109),
  ('relation -> ASSIGN','relation',1,'p_relation1','analizador_Sintactico.py',113),
  ('relation -> NE','relation',1,'p_relation2','analizador_Sintactico.py',117),
  ('relation -> LT','relation',1,'p_relation3','analizador_Sintactico.py',122),
  ('relation -> GT','relation',1,'p_relation4','analizador_Sintactico.py',126),
  ('relation -> LTE','relation',1,'p_relation5','analizador_Sintactico.py',130),
  ('relation -> GTE','relation',1,'p_relation6','analizador_Sintactico.py',135),
  ('expression -> term','expression',1,'p_expression1','analizador_Sintactico.py',139),
  ('expression -> addingOperator term','expression',2,'p_expression2','analizador_Sintactico.py',143),
  ('expression -> expression addingOperator term','expression',3,'p_expression3','analizador_Sintactico.py',147),
  ('addingOperator -> PLUS','addingOperator',1,'p_addingOperator1','analizador_Sintactico.py',151),
  ('addingOperator -> MINUS','addingOperator',1,'p_addingOperator2','analizador_Sintactico.py',155),
  ('term -> factor','term',1,'p_term1','analizador_Sintactico.py',159),
  ('term -> term multiplyingOperator factor','term',3,'p_term2','analizador_Sintactico.py',163),
  ('multiplyingOperator -> TIMES','multiplyingOperator',1,'p_multiplyingOperator1','analizador_Sintactico.py',167),
  ('multiplyingOperator -> DIVIDE','multiplyingOperator',1,'p_multiplyingOperator2','analizador_Sintactico.py',171),
  ('factor -> ID','factor',1,'p_factor1','analizador_Sintactico.py',175),
  ('factor -> NUMBER','factor',1,'p_factor2','analizador_Sintactico.py',179),
  ('factor -> LPARENT expression RPARENT','factor',3,'p_factor3','analizador_Sintactico.py',183),
  ('empty -> <empty>','empty',0,'p_empty','analizador_Sintactico.py',187),
]
